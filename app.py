...
SCHEMA_FILES = {
    (3.0, 3, "HMS-1000"): "schemas/schema_3kwc_hms1000.pdf",   # 6 modules + 3 MO HMS-1000
    (6.0, 6, "HMS-1000"): "schemas/schema_6kwc_hms1000.pdf",   # 12 modules + 6 MO HMS-1000
}


def get_schema_path(puissance_kwc: float, nb_micro_onduleurs: int, modele_mo: str):
    return SCHEMA_FILES.get((puissance_kwc, nb_micro_onduleurs, modele_mo))
